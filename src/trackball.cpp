...
{
    m[0*4+0] = 1.0f - 2.0f * (q[1] * q[1] + q[2] * q[2]);
    m[0*4+1] = 2.0f * (q[0] * q[1] - q[2] * q[3]);
    m[0*4+2] = 2.0f * (q[2] * q[0] + q[1] * q[3]);
    m[0*4+3] = 0.0f;

    m[1*4+0] = 2.0f * (q[0] * q[1] + q[2] * q[3]);
    m[1*4+1] = 1.0f - 2.0f * (q[2] * q[2] + q[0] * q[0]);
    m[1*4+2] = 2.0f * (q[1] * q[2] - q[0] * q[3]);
    m[1*4+3] = 0.0f;

    m[2*4+0] = 2.0f * (q[2] * q[0] - q[1] * q[3]);
    m[2*4+1] = 2.0f * (q[1] * q[2] + q[0] * q[3]);
    m[2*4+2] = 1.0f - 2.0f * (q[1] * q[1] + q[0] * q[0]);
    m[2*4+3] = 0.0f;
